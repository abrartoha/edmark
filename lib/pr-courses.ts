...
// original. Skilled occupation lists change frequently — formal migration
...
export const prCategories: PrCategory[] = [
  {
    ...
    programs: [
      { name: "Certificate III in Carpentry", code: "CPC30220", description: "The trade qualification for carpenters in residential and commercial construction — setting out, building, assembling and installing timber and non-timber structures." },
      ...
      { name: "Certificate III in Electrotechnology Electrician", code: "UEE30820", description: "The pathway to becoming a licensed electrician — installing, testing, fault-finding and maintaining electrical systems safely." },
      ...
      { name: "Certificate III in Light Vehicle Mechanical Technology", code: "AUR30620", description: "Diagnosing, servicing and repairing light vehicles — the trade qualification for automotive mechanics." },
    ],
    eligibility: [
  ...
  },
  {
    ...
    eligibility: [
      ...
      "Higher English requirements apply to nursing (e.g. IELTS Academic 7.0 for registration) — we advise on the exact score",
  ...
  },
  {
    ...
    icon: "trophy",
    tagline: "From trade-level cookery to hospitality management — a clear, in-demand pathway.",
    intro: [
    ...
    programs: [
      ...
      { name: "Certificate III in Hospitality", code: "SIT30622", description: "Front-of-house service across cafes, bars, hotels and restaurants — the entry point to a hospitality career." },
    ],
    eligibility: [
  ...
  },
  {
    ...
    programs: [
      ...
      { name: "Diploma of Early Childhood Education and Care", code: "CHC50121", description: "Qualifies you as a lead educator or room leader. Note: the training package updated in 2025 (CHC50125 now supersedes CHC50121) — we place you in the current version." },
    ...
    eligibility: [
      ...
      "English requirements apply — higher levels are needed for teacher registration",
