          ...
          <div className="card reveal">
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-3 text-sm text-brand-900/70">
                <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-mint-300 text-brand-950 text-xs font-medium">1</span>
              ...
              <li className="flex items-start gap-3 text-sm text-brand-900/70">
                <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-mint-300 text-brand-950 text-xs font-medium">2</span>
