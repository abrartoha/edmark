...
export const metadata: Metadata = pageSeo({
  ...
  description:
    "Edmark is free for students because a commission is paid when a student enrols. What that means for your shortlist, and why you can ask us what we earn on any course we recommend.",
  path: "/how-were-paid",
});
